...
$techniqueDescriptionHash = @{
  ...
  T1558 = "Adversaries may attempt to subvert Kerberos authentication by stealing or foriging Kerberos tickets to enable Pass the Ticket. Kerberos is an authentication protocol widely used in modern Windows domain environments. In Kerberos environments, referred to as 'realms' there are three basic participants= client, service, and Key Distribution Center (KDC)"
